...
def main():
    ...
    while k != -6:
        for i in range(num2Send):
            ...
            # log.debug("index: {:d} \tdist: {:f}".format(i, dist))
        ...
        # ...to do？？这里是否需要mysendArray = SendArray(num2Send, arr)
        # 还是直接mysendArray连接着arr
